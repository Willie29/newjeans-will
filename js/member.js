...
members.forEach((member) => {
    ...
    listItem.className = 'w-[250px] transition-all ease-in-out duration-500 hover:scale-110 hover:drop-shadow-[20px_25px_50px_rgba(0,0,0,1)] hover:text-white';
    listItem.innerHTML = `
        <a href="#member" class="flex flex-col gap-2 items-center">
